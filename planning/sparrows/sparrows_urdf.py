...
class SPARROWS_3D_planner():
    ...
    def trajopt(self, qpos, qvel, waypoint, ka_0, SFO_constraint, time_limit=None, t_final_thereshold=0., tol=1e-5):
    ...
    def plan(self,qpos, qvel, waypoint, obs, ka_0 = None, time_limit=None, t_final_thereshold=0., tol=1e-5):
        ...
        k_opt, flag, constraint_times = self.trajopt(qpos, qvel, waypoint, ka_0, SFO_constraint, time_limit=time_limit, t_final_thereshold=t_final_thereshold, tol=tol)
