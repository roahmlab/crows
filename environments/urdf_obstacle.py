...
class KinematicUrdfWithObstacles(KinematicUrdfBase):
    ...
    def get_observations(self):
        ...
        observations['obstacle_rot'] = self.obs_rot
        return observations
...
if __name__ == '__main__':
    ...
    rob = zpr.ZonoArmRobot.load(os.path.join(basedirname, 'robots/assets/robots/kinova_arm/gen3.urdf'))
    # rob = robots2.ArmRobot('/home/adamli/rtd-workspace/urdfs/panda_arm/panda_arm_proc.urdf')

    test = KinematicUrdfWithObstacles(robot = rob.urdf, step_type='integration', check_joint_limits=True, check_self_collision=True, use_bb_collision=True, render_mesh=True, reopen_on_close=False, n_obs=5, render_fps=30, render_frames=10)
    # test.render()
    test.reset()
    # test.reset(
