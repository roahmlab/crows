...
import torch
from .jrs_trig.process_jrs_trig import process_batch_JRS_trig as _process_batch_JRS_trig, process_batch_JRS_trig_ic as _process_batch_JRS_trig_ic
...
class OfflineJRS:
    ...
    def __call__(
        ...
        if len(qpos.shape) == 1:
            ...
            return _process_batch_JRS_trig_ic(self.jrs_tensor, qpos, qvel, joint_axes)
